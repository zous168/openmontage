...
class TelegramAdapter(BasePlatformAdapter):
    ...
    # Scripts live in ~/.marketing_hub/scripts/gmail-triage/. `arg` from the callback
    ...
    async def _handle_gmail_triage_callback(
        ...
        *,
        ...
        try:
            ...
            script_path = (
                get_default_hermes_root() / "scripts" / "gmail-triage" / script_name
            )
        except ImportError:
            script_path = _Path.home() / ".marketing_hub" / "scripts" / "gmail-triage" / script_name
