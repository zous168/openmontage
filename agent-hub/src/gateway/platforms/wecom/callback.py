...
from gateway.platforms.wecom.adapter import _queue_enabled, _queue_min_interval_seconds
...
class WecomCallbackAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        async def _deliver() -> SendResult:
            return await self._deliver_send(chat_id, content)
