...
Loads environment variables from ``~/.marketing_hub/.env``, configures logging
...
def _load_env() -> None:
    """Load .env from HERMES_HOME (default ``~/.marketing_hub``)."""
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--setup-browser",
        action="store_true",
        help="Install agent-browser + Playwright Chromium into ~/.marketing_hub/node/ "
