...
decomposition campaign (``~/.marketing_hub/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    # 落库已用 persist_user_message；此处再改内存，避免返回/续聊历史带 API 包裹。
    # 必须在全部 LLM 调用之后，绝不能在 turn 开头的 early persist 里做。
