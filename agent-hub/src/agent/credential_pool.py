...
def _seed_from_singletons(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    if provider == "anthropic":
        ...
        # that masquerade.  Prefer ~/.marketing_hub/.env over os.environ for the
        ...
        # MiniMax OAuth tokens live in ~/.marketing_hub/auth.json providers.minimax-oauth.
...
def _seed_from_env(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    # Prefer ~/.marketing_hub/.env over os.environ — the user's config file is the
    ...
    # won't be re-seeded from the user's shell environment or ~/.marketing_hub/.env.
    ...
    if provider == "openrouter":
        # Prefer ~/.marketing_hub/.env over os.environ
