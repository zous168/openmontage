...
Skins are defined as YAML files in ~/.marketing_hub/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "AI Agent"          # Banner title, status display
      agent_tagline: "Messenger of the Digital Gods"  # Banner subtitle
...
.. code-block:: python
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.marketing_hub/skins/
...
Drop a YAML file in ``~/.marketing_hub/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            ...
            "agent_tagline": "Messenger of the Digital Gods",
