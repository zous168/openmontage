...
campaign (``~/.marketing_hub/plans/god-file-decomposition.md``, Phase 2 — splitting
...
def _model_flow_openrouter(config, current_model=""):
    ...
    # in-flow (K/R/C) instead of having to edit ~/.marketing_hub/.env by hand. The
...
def _model_flow_google_gemini_cli(_config, current_model=""):
    ...
    Flow:
      ...
      5. Save to ~/.marketing_hub/config.yaml.
    """
    from hermes_cli.auth import (
