...
const filterGroupClass =
  "flex min-w-0 w-full flex-col items-start gap-1.5 sm:w-auto sm:max-w-full sm:flex-row sm:items-center [&_label]:text-sm [&_label]:font-medium [&_label]:tracking-normal [&_label]:normal-case";

const segmentedClass =
  "w-fit max-w-full flex-wrap justify-start self-start text-sm normal-case tracking-normal";
    ...
    <div className="flex min-w-0 max-w-full flex-col gap-4">
      ...
      <Card className="min-w-0 max-w-full overflow-hidden">
        <CardHeader className="py-3 px-4">
          <CardTitle className="text-sm font-medium normal-case tracking-normal flex items-center gap-2">
        ...
        <CardContent className="p-0">
          ...
          <div
            ref={scrollRef}
            className="max-w-full min-h-[400px] max-h-[calc(100vh-220px)] overflow-auto p-4 font-mono text-sm leading-6 break-words"
          >
