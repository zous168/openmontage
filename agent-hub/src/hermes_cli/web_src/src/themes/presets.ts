...
/** Default system stack — CJK-friendly, no webfont fetch required. */
const SYSTEM_SANS =
...
export const lightGrayTheme: DashboardTheme = {
  name: "lightgray",
  label: "Light Gray",
  description: "Soft white-gray paper — light surface with dark ink",
  palette: {
    background: { hex: "#ececef", alpha: 1 },
    midground: { hex: "#1f2430", alpha: 1 },
    foreground: { hex: "#000000", alpha: 0 },
    warmGlow: "rgba(90, 100, 120, 0.10)",
    noiseOpacity: 0.25,
  },
  typography: DEFAULT_TYPOGRAPHY,
  layout: DEFAULT_LAYOUT,
  terminalBackground: "#1e1e1e",
  swatchColors: ["#ececef", "#1f2430", "#c9cdd6"],
};
...
/** First-run / unset preference — 浅灰 light surface. */
export const DEFAULT_DASHBOARD_THEME_NAME = "lightgray";
