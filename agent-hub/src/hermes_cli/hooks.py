...
Consent records live under ``~/.marketing_hub/shell-hooks-allowlist.json`` and
hook definitions come from the ``hooks:`` block in ``~/.marketing_hub/config.yaml``
...
def _cmd_list(_args) -> None:
    ...
    if not specs:
        print("No shell hooks configured in ~/.marketing_hub/config.yaml.")
