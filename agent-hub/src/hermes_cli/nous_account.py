    ...
    *,
    ...
    if account_info is None:
        return (
            ...
            f"is unavailable. Go to Settings → Main Model to refresh your login, or check "
    ...
    if not account_info.logged_in:
        ...
        return (
            f"Log in to Nous Portal to use {capability}: go to Settings → Main Model. "
    ...
    if account_info.paid_service_access is None:
        ...
        if include_refresh_hint:
            detail += " Go to Settings → Main Model to refresh your session."
    ...
    if reason == "account_missing":
        return (
            ...
            f"login, so {capability} is unavailable. Go to Settings → Main Model to "
    ...
    if reason == "no_usable_credits" or account_info.paid_service_access is False:
        ...
        if include_refresh_hint and not account_info.fresh:
            message += " If you recently bought credits, go to Settings → Main Model to refresh Hermes."
        return message
