...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.(?:marketing_hub|hermes)/\.env|\~/\.(?:marketing_hub|hermes)/\.env', "hermes_env", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*\.(?:marketing_hub|hermes)/(config\.yaml|SOUL\.md)', "hermes_config_mod", "strict"),
