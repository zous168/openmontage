...
~/.marketing_hub/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.marketing_hub/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.marketing_hub/skills/) first, then any
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    ...
    # Default profile (~/.marketing_hub/skills) — only consider when active is non-default.
    ...
    # All named profiles (~/.marketing_hub/profiles/*/skills)
