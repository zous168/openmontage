...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(self, host: str, user: str, cwd: str = "~",
        ...
        self._sync_manager = FileSyncManager(
            get_files_fn=lambda: iter_sync_files(f"{self._remote_home}/.marketing_hub"),
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.marketing_hub directory tree on remote in one SSH call."""
        base = f"{self._remote_home}/.marketing_hub"
    ...
    def _ssh_bulk_download(self, dest: Path) -> None:
        ...
        rel_base = f"{self._remote_home}/.marketing_hub".lstrip("/")
        ssh_cmd = self._build_ssh_command()
