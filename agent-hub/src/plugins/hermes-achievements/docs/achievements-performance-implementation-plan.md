...
- Snapshot persisted at `~/.marketing_hub/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.marketing_hub/plugins/hermes-achievements/scan_checkpoint.json`.
