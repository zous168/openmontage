...
Storage path:
- `~/.marketing_hub/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.marketing_hub/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.marketing_hub/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.marketing_hub/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.marketing_hub/plugins/hermes-achievements/scan_checkpoint.json` (new)
