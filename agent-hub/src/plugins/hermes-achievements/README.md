...
```bash
git clone https://github.com/PCinkusz/hermes-achievements ~/.marketing_hub/plugins/hermes-achievements
```
...
ln -s ~/hermes-achievements ~/.marketing_hub/plugins/hermes-achievements
```
...
```bash
cd ~/.marketing_hub/plugins/hermes-achievements
git pull --ff-only
curl http://127.0.0.1:9119/api/dashboard/plugins/rescan
```
