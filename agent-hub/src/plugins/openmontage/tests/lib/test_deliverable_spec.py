...
from plugins.openmontage.lib.deliverable_spec import (
    DELIVERABLE_KEYS,
...
class TestEnrichProjectDeliverable:
    def test_enrich_render_inputs_from_project_meta(self, tmp_path, monkeypatch):
        from plugins.openmontage.lib import events
    ...
    def test_enrich_generation_inputs_sets_aspect_ratio(self, tmp_path, monkeypatch):
        from plugins.openmontage.lib import paths
        ...
        from plugins.openmontage.lib.deliverable_spec import enrich_generation_inputs
