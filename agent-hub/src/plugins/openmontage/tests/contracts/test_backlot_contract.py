...
from plugins.openmontage.lib.events import emit_event, infer_project_dir, read_events
...
class TestEvents:
    ...
    def test_infer_project_dir_from_output_path(self):
        from plugins.openmontage.lib.events import PROJECTS_DIR
...
class TestBaseToolInstrumentation:
    def test_execute_emits_events(self, tmp_path, monkeypatch):
        import plugins.openmontage.lib.events as events_mod
        monkeypatch.setattr(events_mod, "PROJECTS_DIR", tmp_path)

        from plugins.openmontage.tools.base_tool import BaseTool, ToolResult
    ...
    def test_execute_emits_error_event_and_reraises(self, tmp_path, monkeypatch):
        ...
        from plugins.openmontage.tools.base_tool import BaseTool
