...
def test_agent_guide_has_pipeline_bypass_hard_rule():
    ...
    assert "decision_log.append_decisions" in guide or "plugins.openmontage.lib.decision_log" in guide
...
def test_dogfood_scripts_carry_non_production_marker(name: str):
    from plugins.openmontage.lib.production_audit import is_non_production_script
