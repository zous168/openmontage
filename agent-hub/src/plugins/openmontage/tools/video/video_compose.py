...
class VideoCompose(BaseTool):
    ...
    def _build_theme_from_playbook(
        ...
        if playbook_name:
            try:
                from plugins.openmontage.styles.playbook_loader import load_playbook
    ...
    def _render_via_hyperframes(
        ...
        *,
        ...
        if not playbook_data:
            ...
            if playbook_name:
                try:
                    from plugins.openmontage.styles.playbook_loader import load_playbook  # type: ignore
    ...
    def _encode(self, inputs: dict[str, Any]) -> ToolResult:
        ...
        if profile_name:
            try:
                from plugins.openmontage.lib.media_profiles import get_profile, ffmpeg_output_args
