...
class HyperFramesCompose(BaseTool):
    ...
    def _resolve_dimensions(
        ...
        if profile_name:
            try:
                from plugins.openmontage.lib.media_profiles import get_profile  # type: ignore
    ...
    def _style_bridge(
        ...
        """
        try:
            from plugins.openmontage.lib.hyperframes_style_bridge import style_bridge  # type: ignore
