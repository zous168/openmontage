...
def _instrument_execute(fn: Callable) -> Callable:
    ...
    def wrapper(self, inputs: Any, *args: Any, **kwargs: Any):
        ...
        try:
            from plugins.openmontage.lib.events import emit_event, infer_project_dir
        except Exception:
        ...
        if isinstance(inputs, dict):
            try:
                from plugins.openmontage.lib.deliverable_spec import enrich_project_deliverable
