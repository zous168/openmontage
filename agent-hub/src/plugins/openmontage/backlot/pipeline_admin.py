...
from plugins.openmontage.backlot.bootstrap import BootstrapError, bootstrap_fields_for_pipeline, pipeline_ui_from_manifest
from plugins.openmontage.backlot.dependency_catalog import tool_label_zh
from plugins.openmontage.backlot.skill_catalog import stage_label_zh
...
from plugins.openmontage.lib.paths import SCHEMAS_DIR as _SCHEMAS_DIR
from plugins.openmontage.lib.paths import SKILLS_DIR as _SKILLS_ROOT

_ARTIFACTS_SCHEMA_DIR = _SCHEMAS_DIR / "artifacts"
