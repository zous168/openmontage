...
from plugins.openmontage.lib.checkpoint import PROJECTS_DIR, init_project
from plugins.openmontage.lib.paths import BACKLOT_STATE_DIR, REPO_ROOT, STYLES_DIR
from plugins.openmontage.lib.pipeline_loader import PIPELINE_DEFS_DIR, list_pipelines, load_pipeline_readonly
from plugins.openmontage.lib.source_media_review import detect_media_type
...
MEDIA_STAGING_DIR = BACKLOT_STATE_DIR / "media-staging"
...
def bootstrap_fields_for_pipeline(pipeline_id: str) -> list[dict[str, Any]]:
    ...
    from plugins.openmontage.lib.deliverable_spec import deliverable_bootstrap_fields
    from plugins.openmontage.lib.publish_intake import cover_bootstrap_fields
...
def validate_production_inputs_partial(
    ...
    *,
    ...
    from plugins.openmontage.lib.deliverable_spec import DELIVERABLE_KEYS, normalize_deliverable_field
    from plugins.openmontage.lib.publish_intake import COVER_KEYS, normalize_cover_field
...
def load_project_settings(project_dir: Path) -> dict[str, Any]:
    ...
    from plugins.openmontage.backlot.state import source_media_summary
    from plugins.openmontage.lib.deliverable_spec import resolve_deliverable
    from plugins.openmontage.lib.publish_intake import resolve_cover_brief
