...
from tools.analysis.viddown_client import (
    VidDownError,
    _pick_format,
...
def test_fetch_douyin_via_viddown_happy_path():
    ...
    with patch("tools.analysis.viddown_client._http", side_effect=fake_http):
...
def test_normalize_media_url_from_bootstrap():
    from backlot.bootstrap import normalize_media_url
